...
/*void Game::applica_carta(Carta* carta_applicata, giocatore* giocatore){
	carta_applicata->getMessaggio();
	pause();
	carta_applicata->effetto_carta(giocatore);
}*/

/*Carta* Game::pesca_carta(){
	return applica_carta(m->pesca(),giocatore);
}*/
